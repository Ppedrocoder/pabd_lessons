...
urlpatterns = [
    ...
    path('api/registro/', UsuarioViewSet.as_view({'post': 'registro'}), name='registro'),
    path('api/login/', UsuarioViewSet.as_view({'post': 'login'}), name='login'),
    path('api/login_usuario/', UsuarioViewSet.as_view({'post': 'login_usuario'}), name='login_usuario'),
    path('api/perfil/', UsuarioViewSet.as_view({'get': 'perfil'}), name='perfil'),
    path('api/perfil_usuario/', UsuarioViewSet.as_view({'get': 'perfil_usuario'}), name='perfil_usuario'),
